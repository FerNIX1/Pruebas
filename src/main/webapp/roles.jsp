...
<div class="row">
    <div class="container">
        ...
        <br>
        <a class="btn btn-primary" href="agregarRol.jsp" role="button">Agregar Nuevo Rol</a>
        <table class="table table-bordered">
            ...
            <tbody>
            <c:forEach var="rol" items="${requestScope.listaRoles}">
                <tr>
                    <td>${rol.rl_id}</td>
                    <td>${rol.rl_nombre}</td>
                    <td><a href="${pageContext.request.contextPath}/roles.do?op=editar&id=${rol.rl_id}" class="btn btn-primary">Edit</a>
                        <a href="${pageContext.request.contextPath}/roles.do?op=eliminar&id=${rol.rl_id}" class="btn btn-danger">Delete</a></td>
                </tr>
            </c:forEach>
            </tbody>
